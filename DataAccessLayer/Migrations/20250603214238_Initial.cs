        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicationUserInfoId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_ApplicationUsers_ApplicationUserInfoId",
                        column: x => x.ApplicationUserInfoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostComments_ApplicationUsers_ApplicationUserInfoId",
                        column: x => x.ApplicationUserInfoId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostVotes_ApplicationUsers_ApplicationUserInfoId",
                        column: x => x.ApplicationUserInfoId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostComments_ApplicationUserInfoId",
                table: "PostComments",
                column: "ApplicationUserInfoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_ApplicationUserInfoId",
                table: "Posts",
                column: "ApplicationUserInfoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostVotes_ApplicationUserInfoId",
                table: "PostVotes",
                column: "ApplicationUserInfoId");
